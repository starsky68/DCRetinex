...
class Inference(nn.Module):
    def __init__(self, ):
        ...
        self.model_Decom_low = load_initialize(self.model_Decom_low, '/home/jinyutao/RePI/teacher_model/URetinexNet/ckpt/init_high.pth')#self.opts.Decom_model_low_path
        # loading R; old_model_opts; and L model
        self.unfolding_opts, self.model_R, self.model_L= load_unfolding('/home/jinyutao/RePI/teacher_model/URetinexNet/ckpt/unfolding.pth')#self.opts.unfolding_model_path
        # loading adjustment model
        self.adjust_model = load_adjustment('/home/jinyutao/RePI/teacher_model/URetinexNet/ckpt/L_adjust.pth')#self.opts.adjust_model_path
        self.P = P()
        self.Q = Q()
        transform = [
            transforms.ToTensor(),
    ...
    def lllumination_adjust(self, L, ratio=5):
    ...
    def forward(self, input_low_img):
        ...
        with torch.no_grad(): 
            ...
            High_L = self.lllumination_adjust(L)
            I_enhance = High_L * R
        return I_enhance,High_L,R
    '''
