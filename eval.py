...
parser.add_argument('--data_test', type=str, default='/DCRetinex/datasets/baidu')

parser.add_argument('--model', default='/DCRetinex/ckpt/RePINet/best_psnr_RePILossTP_urtx.pth', help='Pretrained base model')    
parser.add_argument('--output_folder', type=str, default='outputs/')
parser.add_argument('--label_folder', type=str, default='/datasets/tests/SICE/GT_256/')
